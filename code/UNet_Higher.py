...
class UNetHigher(nn.Module):
    def __init__(self, num_classes):
        super(UNetHigher, self).__init__()
        self.enc1 = _EncoderBlock(1, 4)
        self.enc2 = _EncoderBlock(4, 8)
        self.enc3 = _EncoderBlock(8, 16)
        self.enc4 = _EncoderBlock(16, 32)
        self.enc5 = _EncoderBlock(32, 64)
        self.enc6 = _EncoderBlock(64, 128, dropout=True)
        self.center = _DecoderBlock(128, 256, 128)
        self.dec6 = _DecoderBlock(256, 128, 64)
        self.dec5 = _DecoderBlock(128, 64, 32)
